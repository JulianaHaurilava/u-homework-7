...
public class TextSwitcher : MonoBehaviour
{
    private string[] RULES_TEXT = { "У вас есть все необходимое, чтобы наконец восстать против режима. " +
        ...
        "Сыщики в свою очередь противостоят нашей агитационной работе. " +
            "Вместе с лимонами они совершают набеги на наш штаб и конфискуют напечатанные листовки. Каждый сыщик уносит по две листовки.\r\n",
        "Если при набеге обнаруживаются листовки, при следующей облаве сыщиков станет на два больше, чем было до этого. " +
            "Поэтому все листовки должны по возможности вовремя распространяться среди населения.\r\n"};
